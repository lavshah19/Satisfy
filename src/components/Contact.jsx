...
const Contact = () => {
  return (
    <>
      <div className="p-4  min-h-screen flex flex-col md:flex-row items-center justify-center">
        {/* Left Side: Contact Information */}
        <div className="flex-1 mb-8 md:mb-0 md:mr-8 bg-indigo-600 shadow-md rounded-lg p-6 flex items-center justify-center flex-col">
